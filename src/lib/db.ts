...
interface ExternalWithdrawalRequestRow {
  id: string;
  user_id: string;
...
const EXTERNAL_WITHDRAWAL_REQUEST_SELECT = `
  id,
  user_id,
  from_account_id,
  amount,
...
function toExternalWithdrawalRequest(row: ExternalWithdrawalRequestRow): ExternalWithdrawalRequest {
  return {
    id: row.id,
    userId: row.user_id,
