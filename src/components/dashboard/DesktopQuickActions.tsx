    ...
    <section className="rounded-2xl border-[0.5px] border-[color:var(--color-border-tertiary,#d9d7cf)] bg-white p-4">
      ...
      <div className="mt-4 grid gap-2.5">
        <button
          ...
          className="inline-flex items-center justify-between rounded-2xl border border-[#F4C7B9] bg-[#FFF7F3] px-4 py-3 text-left transition-colors hover:bg-[#FDEDE7]"
        >
          <span>
        ...
        <button
          type="button"
          onClick={onAddIncome}
          className="inline-flex items-center justify-between rounded-2xl border border-[#BFE7D8] bg-[#F3FBF7] px-4 py-3 text-left transition-colors hover:bg-[#E1F5EE]"
        >
          <span>
